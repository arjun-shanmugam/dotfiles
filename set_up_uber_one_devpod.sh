...
rm -rvf /home/user/.local/state/nvim
mkdir -p /home/user/.local/state/nvim
curl -L -o /home/user/.local/state/nvim.tar.gz https://github.com/arjun-shanmugam/dotfiles/raw/refs/heads/main/nvim.tar.gz
tar -xzf /home/user/.local/state/nvim.tar.gz -C /home/arjun.shanmugam/.local/state
tar -xzf /home/user/.local/state/nvim.tar.gz -C /home/arjun.shanmugam/.config
cd ~
